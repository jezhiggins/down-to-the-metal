...
[NOTE.speaker]
--
Since the invention of devices like this programmers have communicated with their computers through the medium of text.
...
High end video displays came in around 1970, with the more every day VT52 launching in 1974.

These days of course, many  of are rocking
--
